...
class Automate(AutomateBase):
    ...
    def accepte(auto,mot) :
        ...
        for i in liste : #On parcourt l'ensemble des etats obtenus
            for e in auto.getListFinalStates() : #On parcourt l'ensemble des etats finaux
                if i == e : #Si un etat de notre liste est dans la liste des etats finaux
                    return True 
        return False
    ...
    def completeAutomate(auto,alphabet) :
        ...
        cpt = 0
        for i in auto.listStates : #On recupere le nombre de states déjà existants
            cpt = cpt + 1 

        puit = State(cpt,False,False) #On construit notre puit
